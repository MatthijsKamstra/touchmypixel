...
class Keys
{
	...
	/* experimental
	 */
	public static inline var WINDOWS_KEY_LEFT:Int = 91;
	public static inline var WINDOWS_KEY_RIGHT:Int = 92;
	public static inline var WINDOWS_RIGHT_CLICK:Int = 93;
	public static inline var WINDOWS_VOLUME_DOWN:Int = 174;
	public static inline var WINDOWS_VOLUME_UP:Int = 175;
	public static inline var WINDOWS_VOLUME_MUTE:Int = 173;
	public static inline var WINDOWS_PLAY_PAUSE:Int = 179;
	public static inline var WINDOWS_BACK:Int = 166;
	public static inline var WINDOWS_FORWARD:Int = 167;
	public static inline var NUM_LOCK:Int = 144;
	public static inline var SCROLL_LOCK:Int = 145;
	public static inline var PAUSE_BREAK:Int = 19;
}